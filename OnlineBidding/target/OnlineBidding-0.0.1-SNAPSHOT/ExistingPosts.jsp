...
%>
    ...
    <div class="container-fluid">
      <div class="row">
	    ...
	    {
	    	%><tr>
	    	 	  <td name ="itemids" value=<%products.getITEMID(index); %>><%out.print(products.getITEMID(index)); %></td>
	    ...
	    <c:forEach items="${PRODUCTS}" var="current">
	        <tr style="display:none;">
              ...
              <!--   <tr>
                  ...
                  <td>sit</td>
				  <td>sit</td>
				  <td><a href="BiddingDescriptionPage.html"><input type="button" onClick="" value="56$"></a><a href="BiddingDescriptionPage.html"><input type="button" onClick="" value="56$"></a><a href="BiddingDescriptionPage.html"><input type="button" onClick="" value="56$"></a><a href="BiddingDescriptionPage.html"><input type="button" onClick="" value="56$"></a></td>
