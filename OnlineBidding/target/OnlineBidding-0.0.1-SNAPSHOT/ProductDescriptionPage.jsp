...
%>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item">
          <a href="about.htm" ><img class="first-slide" src="" alt="First slide" ></a>
          <div class="container">
        ...
        <div class="item">
          <a href="contact.htm" ><img class="second-slide" src="" alt="Second slide"></a>
          <div class="container">
            <div class="carousel-caption">
              <h1>Address</h1>
              <p></p>
        ...
        <div class="item active">
          <a href="gallery.htm" ><img class="third-slide" src="http://media1.santabanta.com/full5/Architecture/Roads/roads-89a.jpg" alt="Third slide" ></a>
          <div class="container">
            <div class="carousel-caption">
              <h1>CONTACT US</h1>
              <p></p>
	...
	<p id="b" align="center">
					<h1 align="center">DETAILS OF THE PRODUCT</h1>
					...
					<table frame="void" id="myTable" align= "center" >
						...
						        </select> -->
							  ...
							  <tr><td><div><b>Price User Wants to Buy at:</b></div></td><td><div ><input name="expPrice" type="text" readonly value=<%out.print(itemPrice);%>><!--<input type="number" min="1" step="any" required />--></div></td></tr>
				   ...
				   <h1 align="center">INTERESTED IN THIS ITEM ?</h1>
					...
					<table frame="void" id="myTable" align= "center" >
						...
						        </select>
							  ...
							  <tr><td><div><b>Price you wan to sell at:</b></div></td><td><div ><input name="actPrice" type="number" min="1" step="any" required >
