               ...
               <% for(int index = 0; index < products.getListSize(); index++)
	    {
	    	...
	    	%>
	    		...
	    		<tr class="table">
	    	      ...
	    	      <td  name="itemi" value=<%products.getITEMID(index); %>><%out.print(products.getITEMID(index)); %></td>
	    ...
	    <c:forEach items="${PRODUCTS}" var="current">
	        <tr style="display:none;">
             ...
             <!--   <tr>
				  ...
				  <td>Mccallum Blvd</td>
				  <td>Dallas</td>
				  <td><a href="ProductDescriptionPage.html"><input type="button" class="btn btn-lg btn-primary"  onClick="" value="Bid"></a></td>
