...
public class AddToCartService {
	...
	public Response addNewUser(String data) {
		...
		isAddNewUserSuccessful = DBOperation.AddBidToCart(bidID,itemName,postUserEmail,bidUserEmail,itemID,bidderId,postUserID,expDesc,expQuality,expPrice, actDesc, actQuality, actPrice);
